 ...
 * Clientele
 *
 * @ORM\Table(name="clientele")
 * @ORM\Entity(repositoryClass="kiraxe\AdminCrmBundle\Repository\ClienteleRepository")
 */
class Clientele
{
    /**
     ...
     * @var string
     *
     * @ORM\Column(name="avto", type="string", length=255)
     */
    private $avto;
